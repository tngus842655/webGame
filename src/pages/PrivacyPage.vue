  ...
  <div class="privacy">
    <header class="privacy-header">
      ...
      <div>
        ...
        <p class="effective">시행일자 2026년 9월 1일</p>
      </div>
    </header>

    <div class="card">
      <p class="intro">
        미니게임30(이하 "서비스")은 이용자의 개인정보를 중요하게 생각하며, 아래와 같이
        개인정보를 수집·이용합니다. 서비스는 회원가입 없이 이용할 수 있으며, 꼭 필요한
        최소한의 정보만 다룹니다.
      </p>
      ...
      <ul>
        ...
        <li v-if="isInToss">토스가 발급한 미니앱 전용 익명 식별키</li>
        <li v-if="isInToss">
          토스 로그인 시(선택): 토스가 발급한 사용자 식별값(userKey), 이름, 이메일 주소
        </li>
        <li v-else>SNS 연동 시(선택): 구글·카카오 계정 식별자, 닉네임, 프로필 사진, 이메일 주소</li>
        <li>서비스 이용 정보: 게임 점수, 플레이 시간, 보상형 광고 시청 기록</li>
        <li>
          광고 식별자: 보상형 광고를 볼 때 광고 매체가 기기의 광고 ID를 이용합니다
          (서비스가 직접 수집하거나 보관하지는 않습니다)
        </li>
      </ul>
      ...
      <ul>
        ...
        <li v-if="isInToss">이벤트 중복 참여 방지</li>
      ...
      <p>
        서비스 제공 기간 동안 보유하며, 이용자가 삭제를 요청하면 계정과 게임 기록을 지체
        없이 삭제합니다.
      </p>

      <h2>4. 개인정보의 처리 위탁</h2>
      <p>서비스는 운영과 광고 게재를 위해 아래 업체에 개인정보 처리를 위탁하며, 그 밖의 제3자에게는 제공하지 않습니다. 위탁 업체의 서버는 국외(미국)에 위치할 수 있습니다.</p>
      <ul>
        <li>Supabase Inc. — 계정 인증, 데이터베이스 보관</li>
        <li>Vercel Inc. — 웹 호스팅, 콘텐츠 전송</li>
        <li v-if="isInToss">비바리퍼블리카(토스) — 미니앱 내 보상형 광고 게재</li>
        <li v-else>Google LLC — 보상형 광고 게재 및 게재 성과 측정 (AdMob·AdSense)</li>
      </ul>

      <h2>5. 이용자의 권리</h2>
      <p>
        닉네임은 설정에서 언제든지 직접 변경할 수 있으며, 아래 문의처를 통해 본인 기록의
        열람·삭제를 요청할 수 있습니다.
      </p>
      <p>
        맞춤형 광고를 원하지 않으시면 기기의 광고 설정에서 광고 ID를 초기화하거나 맞춤
        광고를 끌 수 있습니다. 광고 시청은 선택 사항이며, 보지 않아도 모든 게임을 그대로
        이용할 수 있습니다.
      </p>

      <h2>6. 안전성 확보 조치</h2>
      <p>
        모든 통신 구간은 암호화(HTTPS)되며, 게임 기록은 본인 계정만 기록할 수 있도록 접근을
        제한합니다. 비밀번호는 별도로 수집·보관하지 않습니다.
      </p>
