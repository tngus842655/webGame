...
const en = {
  ...
  'admin.title': 'Admin',
  'admin.hint':
    'Games checked as New go on the New tab of the home screen (up to 3) and stand first in line for the daily pick. Order follows the sequence you checked them in; unchecking one pulls the rest up. The rest stay in popularity order: the top 3 fill the Popular shelf and the All games tab lists everything. An orange rank on the right means the game dropped out of the top 30. Changes show up the next time the home screen opens.',
  'admin.featured': 'New',
  'admin.hidden': 'Hide',
  'admin.order': 'Order',
