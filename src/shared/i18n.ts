...
const en = {
  ...
  'bb.toDaily': 'Switch to the daily run?',
  'bb.toDailyDesc': "Starts a new board with today's block order — the same one everyone gets.",
  'bb.toFree': 'Switch to free play?',
  'bb.toFreeDesc': 'Blocks come at random, and free play does not count towards your streak.',
  'bb.switchWarn': 'This board will be lost.',
  'bb.switchGo': 'Start a new board',
  'bb.switchStay': 'Keep playing',
  'brick.wave': 'Wave {n}',
  'brick.attack': 'Damage',
