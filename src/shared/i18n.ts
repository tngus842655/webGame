...
const en = {
  ...
  'stats.adsHint':
    'How often the ad button was pressed and how it ended. Tap a game to break it down by spot. "No fill" is the ad never showing (no inventory, frequency cap, error) — the reward is granted anyway, so these are invisible everywhere else.',
