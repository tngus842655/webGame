...
const en = {
  ...
  // 좋아요·싫어요 집계 화면. 기간의 축은 표를 하루 한 번으로 묶는 축(vote_day)과 같다
  'admin.votes': 'Popularity',
  'admin.votesDaily': 'Daily',
  'admin.votesWeekly': 'Weekly',
  'admin.votesMonthly': 'Monthly',
  'admin.votesAll': 'All-time',
  'admin.votesYesterday': 'Yesterday',
  'admin.votesToday': 'Today',
  'admin.votesLastWeek': 'Last week',
  'admin.votesThisWeek': 'This week',
  'admin.votesLastMonth': 'Last month',
  'admin.votesThisMonth': 'This month',
  'admin.votesUp': 'Likes',
  ...
  'stats.playersHint':
    'Longest time first. Tap a name to open what that person played and for how long. Same rolling window as the statistics screen.',
